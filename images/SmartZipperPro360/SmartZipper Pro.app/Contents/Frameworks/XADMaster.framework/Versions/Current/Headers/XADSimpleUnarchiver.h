...
//yifang add interfaces
-(NSMutableArray *)getParserEntries;
-(NSMutableArray *)getParserEntriesWithoutResourceForks;
...
-(void)simpleUnarchiverNeedsPassword:(XADSimpleUnarchiver *)unarchiver;  //具有头文件加密
